...
{Periodistas en Debate.}\label{periodistas-en-debate.}}%Es el título del libro.

{Aportes al estudio del campo periodístico}%Subtítulo del libro como se indica  periodístico}\label{aportes-al-estudio-del-campo-perioduxedstico}}
...
\section{Planteo del problema de investigación}\label{planteo-del-problema-de-investigaciuxf3n}} %1.1
...
\section
\textbf{Objetivos y supuestos de la investigación}%1.2
...
\section{Consideraciones preliminares}\label{consideraciones-preliminares}}%1.3
...
\subsection{Cambio tecnológico y crisis de financiamiento}\label{cambio-tecnoluxf3gico-y-crisis-de-financiamiento}}%1.3.1
...
\subsection{El período dorado}\label{el-peruxedodo-dorado}}%1.3.2
...
\subsection{Fin de la época dorada}\label{fin-de-la-uxe9poca-dorada}}%1.3.3
...
\section{Abordaje Metodológico}\label{abordaje-metodoluxf3gico}}%1.4
...
\chapter{Estado de la cuestión y consideraciones teórico-metodológicas}\label{estado-de-la-cuestiuxf3n-y-consideraciones-teuxf3rico-metodoluxf3gicas}}% 2

%\hypertarget{antecedentes-sobre-la-temuxe1tica}{%
\section{Antecedentes sobre la temática}\label{antecedentes-sobre-la-temuxe1tica}}%2.1
...
\subsection{El campo periodístico}\label{el-campo-perioduxedstico}}%2.2.1
...
\subsection{La credibilidad}\label{la-credibilidad}}%2. 2. 2.
...
\subsection{La legitimidad del campo periodístico}\label{la-legitimidad-del-campo-perioduxedstico}}% 2. 2. 3.
...
\subsection{Autonomización del campo periodístico}\label{autonomizaciuxf3n-del-campo-perioduxedstico}}% 2. 2. 4.
...
\section{Los periodistas y el fenómeno editorial}\label{los-periodistas-y-el-fenuxf3meno-editorial}% 3. 1.
...
\section{El contexto político del conflicto en la mirada de la prensa}\label{el-contexto-poluxedtico-del-conflicto-en-la-mirada-de-la-prensa}}% 3.2.
...
\section{Acerca del campo periodístico}\label{acerca-del-campo-perioduxedstico}}% 3. 3.
...
\subsection{ Propuesta de clasificación de periodistas según su lugar en el campo}\label{propuesta-de-clasificaciuxf3n-de-periodistas-seguxfan-su-lugar-en-el-campo}}% 3. 3. 1.
...
\subsection{Categorías de periodistas}\label{categoruxedas-de-periodistas}}% 3. 3. 2.
...
\subsection{ Pseudoperiodistas}\label{pseudoperiodistas}}% 3. 3. 3.
...
\section{Corpus de Análisis}\label{corpus-de-anuxe1lisis}}% 4.1.
...
\section{Periodización}\label{periodizaciuxf3n}}% 4. 2.
...
\subsection{Etapa Preparatoria}\label{etapa-preparatoria}}% 4. 2. 1.
...
\section{Presentación}\label{presentaciuxf3n}} % 5.1.
...
\section{Composición del campo}\label{composiciuxf3n-del-campo}} %5. 2.
...
\section{Estrategias de protección de la legitimidad del campo periodístico}\label{estrategias-de-protecciuxf3n-de-la-legitimidad-del-campo-perioduxedstico}} % 5. 3.
...
\subsection{Protección de la legitimidad del campo. Libertad de expresión}\label{protecciuxf3n-de-la-legitimidad-del-campo.-libertad-de-expresiuxf3n}} %5 . 3.1.
...
\subsection{Protección de la legitimidad del campo periodístico. La independencia}\label{protecciuxf3n-de-la-legitimidad-del-campo-perioduxedstico.-la-independencia}} % 5. 3. 2.
